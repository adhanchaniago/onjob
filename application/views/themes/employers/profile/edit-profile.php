      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="firstname" value="<?= $e_info['firstname']  ?>" placeholder="Enter your first name">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="lastname" value="<?= $e_info['lastname']  ?>" placeholder="Enter your last name">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
