...
<html lang="en">
	<head>
		  <title><?=isset($title)?$title:'ARCHIPELAGO Admin Panel' ?></title>
		  ...
		  <meta name = "keywords" content = "Admin Panel, Backend Panel, Codeigniter admin panel, codeigniter, user management system" />
      	  ...
      	  <meta name = "author" content = "Owltechmedia" />
		  <!-- Bootstrap 3.3.6 -->
		...
		<div class="wrapper" style="height: auto;">
			...
			<section id="container">
				...
				<footer class="main-footer">
					<strong>Copyright © 2019 <a href="https://u.to/fgipFA">Owltechmedia</a></strong> All rights
					reserved.
				</footer>
				<!--footer end-->
			</section>
